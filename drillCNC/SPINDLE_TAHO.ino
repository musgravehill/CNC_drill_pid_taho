...
void TAHO_calc_PRM() {
  ...
  TAHO_RPM = TAHO_rotationCount * 30000L / (TAHO_curr_ms - TAHO_prev_ms); //rot per minute   60 000ms = 60s = 1 minute  2-holes => 60\2 = 30
  PID_input_0_1023 = map(TAHO_RPM, 0, 8000, 0, 1023);
